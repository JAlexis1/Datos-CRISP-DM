...
class DescriptiveGraphics:
    ...
    def __target_distribution(self):
        ...
        self.df["Fraud_Label"].value_counts().plot(kind="bar", color=["green", "red"])
    ...
    def __probability_of_fraude(self):
        ...
        plot_df["Risk_Decile"] = pd.qcut(plot_df["Risk_Score"], q=10, labels=False) + 1
        ...
        plt.xlabel(
            "Decil del puntaje de riesgo\n(1 = Menos riesgoso, 10 = Más riesgoso)",
            fontsize=13,
        )
